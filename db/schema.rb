...
ActiveRecord::Schema.define(version: 20150305212625) do
  ...
  add_index "answer_choices", ["text", "question_id"], name: "index_answer_choices_on_text_and_question_id", unique: true
  ...
  add_index "questions", ["text", "poll_id"], name: "index_questions_on_text_and_poll_id", unique: true
